...
const WORDS_3000_MAP = {
  ...
  "汚い": ("kitanai", "dirty"),
  "茶色": ("chairo", "brown"),
  "空く": ("suku/aku", "be empty, become less crowded/become available, become vacant"),
  ...
  "上がる": ("agaru", "go up, rise (physically), get nervous, increase in quality or quantity"),
  ...
  "明日": ("ashita/asu/myounichi", "tomorrow/tomorrow (formal)/tomorrow (very formal)"),
