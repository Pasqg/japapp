...
const EASY_SENTENCES = {
  ...
  "秋は木の葉が赤いです": (
    ...
    "The leaves of the trees are red in autumn"
  ),
  ...
  "秋は風が涼しいです": ("aki wa kaze ga suzushii desu", "The wind is cool in autumn"),
...
const WORDS_3000_MAP = {
  ...
  "渡る": ("wataru", "cross, go across"),
  "途中": ("tochuu", "on the way, half way"),
  "インタビュー": ("intabyu-", "interview (loan word)"),
  "盗む": ("nusumu", "steal, rob"),
  ...
  "スケジュール": ("sukeju-ru", "schedule (loan word)"),
