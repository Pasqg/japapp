const SINGLE_KANJI_WORDS = {
  "家": ("ie", "home, house, household, dwelling"),
  "私": ("watashi", "I"),
  "所": ("tokoro", "place"),
  "今": ("ima", "now"),
  "私たち": ("watashitachi", "we"),
  ...
  "日": ("hi/nichi", "day, sun, daytime/counter for days"),
  "水": ("mizu", "water"),
  "二": ("ni", "two"),
  "三": ("san", "three"),
  "千": ("sen", "thousand"),
  ...
  "先": ("saki", "ahead, first"),
  "四": ("shi", "four"),
  "下": ("shita/moto", "under, below/under someone's, supervision"),
  "父": ("chichi", "own father"),
  "母": ("haha", "own mother"),
  "月": ("tsuki", "moon"),
  ...
  "何": ("nani", "what"),
  "人": ("hito", "person"),
  "方": ("hou/kata", "direction, side/person (polite)"),
  "他": ("hoka/ta", "other"),
  ...
  "零": ("rei", "zero"),
  "雲": ("kumo", "cloud"),
  "空": ("sora/kara", "sky/emptiness, hollow"),
  ...
  "塩": ("shio", "salt"),
  "中": ("naka/chuu", "inside, middle/middle, medium size"),
  "魚": ("sakana", "fish"),
  "味": ("aji", "taste, flavor"),
  ...
  "箸": ("hashi", "chopsticks"),
  "訳": ("yaku/wake", "translation/reason, sense"),
  "角": ("kado", "corner, edge"),
  "床": ("yuka", "floor"),
  "例": ("Rei", "example"),
  "鍋": ("nabe", "pan"),
  ...
  "汗": ("ase", "sweat"),
  "表": ("omote/hyou", "front, outside/table, list"),
  ...
  "甥": ("oi", "nephew"),
  "鰻": ("unagi", "eel"),
  "生": ("nama/sei", "raw, fresh/life, living"),
...
const DOUBLE_KANJI_WORDS = {
  ...
  "今日": ("kyou/konnichi", "today/these days"),
  ...
  "毎年": ("maitoshi/mainen", "every year (colloquial/formal)"),
  "新年": ("shinnen", "new year"),
  ...
  "昨日": ("kinou/sakujitsu", "yesterday/yesterday (formal)"),
  ...
  "日記": ("nikki", "diary"),
  "明日": (
    "ashita/asu/myounichi",
    "tomorrow/tomorrow (formal)/tomorrow (very formal)"
  ),
  ...
  "日中": ("nicchuu", "during the day, japan and china"),
  ...
  "空く": (
    "suku/aku",
    "be empty, become less crowded/become available, become vacant"
  ),
  ...
  "行く": ("iku", "go"),
  "行き": ("iki/yuki", "going, bound for/bound for (traditional)"),
...
const VERBS = {
  ...
  "起きる": ("okiru", "get up, wake up, occur, happen"),
  ...
  "やる": ("yaru", "do, give to an inferior"),
  "起こる": ("okoru", "happen"),
  "送る": ("okuru", "send"),
  "乗る": ("noru", "ride, take"),
  "いる": ("iru", "be present, stay"),
  "開ける": ("akeru", "open doors or windows"),
  "閉める": ("shimeru", "close doors or windows"),
  "食べる": ("taberu", "eat"),
  ...
  "止める": ("tomeru/yameru", "stop something or someone/give up"),
  ...
  "上がる": (
    "agaru",
    "go up, rise physically, get nervous, increase in quality or quantity"
  ),
  ...
  "びっくりする": ("bikkurisuru", "be surprised, be startled (casual)"),
  ...
  "問い合わせる": ("toiawaseru", "inquire, ask for (information)"),
  ...
  "いらっしゃる": ("irassharu", "come, go (honorific)"),
...
const TRIPLE_KANJI_WORDS = {
  ...
  "姉さん": ("neesan", "older sister (polite)"),
  ...
  "兄さん": ("niisan", "older brother (polite)"),
  ...
  "ご主人": ("goshujin", "someone's else husband"),
  "人混み": ("hitogomi", "crowd"),
  ...
  "大好き": ("daisuki", "to like something a lot"),
  "大きい": ("ooki", "big"),
...
const EASY_SENTENCES = {
  "ここは私の家です": ("koko wa watashi no ie desu", "This is my home"),
  "春が来ました": ("haru ga kimashita", "Spring has come"),
  "今日は車を洗います": ("kyou wa kuruma o araimasu", "Today I will wash the car"),
  "今、冬が始まります": ("ima fuyu ga hajimarimasu", "Now winter is starting"),
  "彼の顔が見えます": ("kare no kao ga miemasu", "I can see his face"),
  "母は日本酒が好きです": ("haha wa nihonshu ga sukidesu", "My mother likes sake"),
  "彼の娘は学校に行きます": (
    "kare no musume wa gakkou ni ikimasu",
    "His daughter goes to school"
  ),
  "その色は好きじゃないです": ("sono iro wa sukijanai desu", "I don't like that color"),
  "あなたの耳が大きいです": ("anata no mimi ga oukii desu", "Your ears are big"),
  "今日は冷たい雨が降ります": (
    "kyou wa tsumetai ame ga furimasu",
    "Today, cold rain is falling"
  ),
  "お腹がすきました": ("onaka ga sukimashita", "I'm hungry"),
  "彼の右足が痛いです": ("kare no migi ashi ga itai desu", "His right leg hurts"),
  "彼女の髪は黒いです": ("kanojo no kami wa kuroi desu", "Her hair is black"),
  "水を飲みます": ("mizu o nomimasu", "I drink water"),
  "この木は大きいです": ("kono ki wa oukii desu", "This tree is big"),
  "今は春です": ("ima wa haru desu", "It is spring now"),
  "彼の顔は赤いです": ("kare no kao wa akai desu", "His face is red"),
  "この車は新しいです": ("kono kuruma wa atarashii desu", "This car is new"),
  "私は毎日水を飲みます": (
    "watashi wa mainichi mizu o nomimasu",
    "I drink water every day"
  ),
  "冬は雪が降ります": ("fuyu wa yuki ga furimasu", "It snows in winter"),
  "この家は古いです": ("kono ie wa furui desu", "This house is old"),
  "彼女は大きな声で話します": (
    "kanojo wa oukina koe de hanashimasu",
    "She speaks in a loud voice"
  ),
  "昼は暖かいです": ("hiru wa atatakai desu", "It is warm during the day"),
  "母は毎日料理を作ります": (
    "haha wa mainichi ryouri o tsukurimasu",
    "My mother cooks every day"
  ),
  "彼は毎朝走ります": ("kare wa maiasa hashirimasu", "He runs every morning"),
  "ここに花があります": ("koko ni hana ga arimasu", "There are flowers here"),
  "この店の肉は美味しいです": (
    "kono mise no niku wa oishii desu",
    "The meat at this store is delicious"
  ),
  "彼は上手に歌います": ("kare wa jouzu ni utaimasu", "He sings well"),
  "姉はとても優しいです": ("ane wa totemo yasashii desu", "My older sister is very kind"),
  "今は夜です": ("ima wa yoru desu", "It is night now"),
  "この本は面白いです": ("kono hon wa omoshiroi desu", "This book is interesting"),
  "彼の頭は良いです": ("kare no atama wa yoi desu", "He is smart"),
  "彼女の目は青いです": ("kanojo no me wa aoi desu", "Her eyes are blue"),
  "彼は毎週運動します": ("kare wa maishuu undou shimasu", "He exercises every week"),
  "この魚は新鮮です": ("kono sakana wa shinsen desu", "This fish is fresh"),
  "今日の天気は晴れです": ("kyou no tenki wa hare desu", "Today's weather is clear"),
  "母は美味しい料理を作ります": (
    "haha wa oishii ryouri o tsukurimasu",
    "My mother makes delicious dishes"
  ),
  "彼の声はとても大きいです": (
    "kare no koe wa totemo oukii desu",
    "His voice is very loud"
  ),
  "ここは静かな場所です": ("koko wa shizukana basho desu", "This is a quiet place"),
  "夜は少し寒いです": ("yoru wa sukoshi samui desu", "It is a little cold at night"),
  "彼女の服はきれいです": ("kanojo no fuku wa kirei desu", "Her clothes are clean"),
  "私は毎日米を食べます": ("watashi wa mainichi kome o tabemasu", "I eat rice every day"),
  "この道は広いです": ("kono michi wa hiroi desu", "This road is wide"),
  "彼の腕は強いです": ("kare no ude wa tsuyoi desu", "His arms are strong"),
  "姉は優しい人です": ("ane wa yasashii hito desu", "My older sister is a kind person"),
  "彼は毎晩本を読みます": (
    "kare wa maiban hon o yomimasu",
    "He reads a book every night"
  ),
  "彼女は新しい靴を買いました": (
    "kanojo wa atarashii kutsu o kaimashita",
    "She bought new shoes"
  ),
  "この花は赤いです": ("kono hana wa akai desu", "This flower is red"),
  "彼の部屋は広いです": ("kare no heya wa hiroi desu", "His room is spacious"),
  "私は毎日牛乳を飲みます": (
    "watashi wa mainichi gyuunyuu o nomimasu",
    "I drink milk every day"
  ),
  "この店の酒は美味しいです": (
    "kono mise no sake wa oishii desu",
    "The sake at this store is delicious"
  ),
  "秋は風が強いです": ("aki wa kaze ga tsuyoi desu", "The wind is strong in autumn"),
  "彼は毎朝早く起きます": (
    "kare wa maiasa hayaku okimasu",
    "He wakes up early every morning"
  ),
  "彼の家は大きいです": ("kare no ie wa oukii desu", "His house is big"),
  "私は毎晩薬を飲みます": (
    "watashi wa maiban kusuri o nomimasu",
    "I take medicine every night"
  ),
  "ここに小さな犬がいます": ("koko ni chiisana inu ga imasu", "There is a small dog here"),
  "彼女の耳は良いです": ("kanojo no mimi wa yoi desu", "Her hearing is good"),
  "母は毎日雑誌を読みます": (
    "haha wa mainichi zasshi o yomimasu",
    "My mother reads magazines every day"
  ),
  "彼はいつも楽しいです": ("kare wa itsumo tanoshii desu", "He is always cheerful"),
  "彼女は水をたくさん飲みます": (
    "kanojo wa mizu o takusan nomimasu",
    "She drinks a lot of water"
  ),
  "この店の米は美味しいです": (
    "kono mise no kome wa oishii desu",
    "The rice at this store is delicious"
  ),
  "冬は体が冷えます": ("fuyu wa karada ga hiemasu", "The body gets cold in winter"),
  "彼の犬は大きいです": ("kare no inu wa oukii desu", "His dog is big"),
  "彼女は毎日運動しています": (
    "kanojo wa mainichi undou shiteimasu",
  ...
  "この花は紫です": ("kono hana wa murasaki desu", "This flower is purple"),
  "今は秋です": ("ima wa aki desu", "It is autumn now"),
  "彼の目は大きいです": ("kare no me wa oukii desu", "His eyes are big"),
  "ここにたくさんの人がいます": (
    "koko ni takusan no hito ga imasu",
    "There are many people here"
  ),
  "夏は暑いです": ("natsu wa atsui desu", "It is hot in summer"),
  "彼女は毎週映画を見ます": (
    "kanojo wa maishuu eiga o mimasu",
    "She watches movies every week"
  ),
  "この店は新しいです": ("kono mise wa atarashii desu", "This store is new"),
  "ここに大きな木があります": ("koko ni oukina ki ga arimasu", "There is a big tree here"),
  "彼は毎日走ります": ("kare wa mainichi hashirimasu", "He runs every day"),
  "この料理は辛いです": ("kono ryouri wa karai desu", "This dish is spicy"),
  "秋の空は青いです": ("aki no sora wa aoi desu", "The autumn sky is blue"),
  "彼女の声は優しいです": ("kanojo no koe wa yasashii desu", "Her voice is gentle"),
  "彼は毎晩テレビを見ます": (
    "kare wa maiban terebi o mimasu",
    "He watches TV every night"
  ),
  "この部屋は暗いです": ("kono heya wa kurai desu", "This room is dark"),
  "今は朝です": ("ima wa asa desu", "It is morning now"),
  "彼女は毎日絵を描きます": (
    "kanojo wa mainichi e o kakimasu",
    "She draws pictures every day"
  ),
  "夏は日が長いです": ("natsu wa hi ga nagai desu", "The days are long in summer"),
  "彼の声は高いです": ("kare no koe wa takai desu", "His voice is high"),
  "この道は狭いです": ("kono michi wa semai desu", "This road is narrow"),
  "彼女の目は大きいです": ("kanojo no me wa oukii desu", "Her eyes are big"),
  "今日は日曜日です": ("kyou wa nichiyoubi desu", "Today is Sunday"),
  "冬の朝は寒いです": ("fuyu no asa wa samui desu", "Winter mornings are cold"),
  "彼の背は高いです": ("kare no se wa takai desu", "He is tall"),
  "彼女は毎晩お茶を飲みます": (
    "kanojo wa maiban ocha o nomimasu",
    "She drinks tea every night"
  ),
  "秋は果物が美味しいです": (
    "aki wa kudamono ga oishii desu",
    "Fruits are delicious in autumn"
  ),
  "この店は安いです": ("kono mise wa yasui desu", "This store is cheap"),
  "彼の声は大きいです": ("kare no koe wa oukii desu", "His voice is loud"),
  "彼女は毎朝新聞を読みます": (
    "kanojo wa maiasa shinbun o yomimasu",
    "She reads the newspaper every morning"
  ),
  "この部屋は暑いです": ("kono heya wa atsui desu", "This room is hot"),
  "彼の顔は疲れて見えます": ("kare no kao wa tsukarete miemasu", "His face looks tired"),
  "彼女の髪は長いです": ("kanojo no kami wa nagai desu", "Her hair is long"),
  "この湖は大きいです": ("kono mizuumi wa oukii desu", "This lake is large"),
  "彼は毎晩音楽を聞きます": (
    "kare wa maiban ongaku o kikimasu",
    "He listens to music every night"
  ),
  "彼女はこの料理が好きです": ("kanojo wa kono ryouri ga sukidesu", "She likes this dish"),
  "この店は静かです": ("kono mise wa shizuka desu", "This store is quiet"),
  "彼の部屋は綺麗です": ("kare no heya wa kirei desu", "His room is clean"),
  "今は昼です": ("ima wa hiru desu", "It is noon now"),
  "彼の靴は新しいです": ("kare no kutsu wa atarashii desu", "His shoes are new"),
  "彼女は毎晩お風呂に入ります": (
    "kanojo wa maiban ofuro ni hairimasu",
    "She takes a bath every night"
  ),
  "この山は高いです": ("kono yama wa takai desu", "This mountain is tall"),
  "彼の手は大きいです": ("kare no te wa oukii desu", "His hands are big"),
  "この道はまっすぐです": ("kono michi wa massugu desu", "This road is straight"),
  "彼女の耳は敏感です": ("kanojo no mimi wa binkan desu", "Her ears are sensitive"),
  "彼の歌は良いです": ("kare no uta wa yoi desu", "His singing is good"),
  "彼の目は優しいです": ("kare no me wa yasashii desu", "His eyes are gentle"),
  "彼女は毎晩本を読みます": (
    "kanojo wa maiban hon o yomimasu",
    "She reads a book every night"
  ),
  "秋は木の葉が赤いです": (
    "aki wa ki no ha ga akai desu",
    "In autumn the leaves of the trees are red"
  ),
  "この部屋は静かです": ("kono heya wa shizuka desu", "This room is quiet"),
  "この犬は小さいです": ("kono inu wa chiisai desu", "This dog is small"),
  "彼の髪は短いです": ("kare no kami wa mijikai desu", "His hair is short"),
  "秋は風が涼しいです": ("aki wa kaze ga suzushii desu", "In autumn the wind is cool"),
  "彼女の手は温かいです": ("kanojo no te wa atatakai desu", "Her hands are warm"),
  "彼は毎日新聞を読みます": (
    "kare wa mainichi shinbun o yomimasu",
    "He reads the newspaper every day"
  ),
  "今は夕方です": ("ima wa yuugata desu", "It is evening now"),
  "この花は綺麗です": ("kono hana wa kirei desu", "This flower is beautiful"),
  "彼の言葉は優しいです": ("kare no kotoba wa yasashii desu", "His words are kind"),
  "冬は暗いです": ("fuyu wa kurai desu", "It is dark in winter"),
  "彼女は毎日運転します": ("kanojo wa mainichi untenshimasu", "She drives every day"),
  "この道は静かです": ("kono michi wa shizuka desu", "This road is quiet"),
  "彼の声は低いです": ("kare no koe wa hikui desu", "His voice is low"),
  "彼は毎日散歩します": ("kare wa mainichi sanpo shimasu", "He takes a walk every day"),
  "この部屋は寒いです": ("kono heya wa samui desu", "This room is cold"),
  "彼女の笑顔は素敵です": ("kanojo no egao wa suteki desu", "Her smile is lovely"),
  "彼の耳は大きいです": ("kare no mimi wa oukii desu", "His ears are big"),
  "秋の葉は黄色いです": ("aki no ha wa kiiroi desu", "The autumn leaves are yellow"),
  "彼女の背は高いです": ("kanojo no se wa takai desu", "She is tall"),
  "この湖は深いです": ("kono mizuumi wa fukai desu", "This lake is deep"),
  "彼は毎晩日記をつけます": (
    "kare wa maiban nikki o tsukemasu",
    "He keeps a diary every night"
  ),
  "彼の手は冷たいです": ("kare no te wa tsumetai desu", "His hands are cold"),
  "彼女は毎晩映画を見ます": (
    "kanojo wa maiban eiga o mimasu",
    "She watches movies every night"
  ),
  "秋は空が青いです": ("aki wa sora ga aoi desu", "The sky is blue in autumn"),
  "彼の髪は長いです": ("kare no kami wa nagai desu", "His hair is long"),
  "この木は古いです": ("kono ki wa furui desu", "This tree is old"),
  "彼は毎日勉強します": ("kare wa mainichi benkyou shimasu", "He studies every day"),
  "この山は大きいです": ("kono yama wa oukii desu", "This mountain is big"),
  "秋の夜は寒いです": ("aki no yo wa samui desu", "Autumn nights are cold"),
  "彼女は毎朝早く起きます": (
    "kanojo wa maiasa hayaku okimasu",
    "She wakes up early every morning"
  ),
  "彼の声は優しいです": ("kare no koe wa yasashii desu", "His voice is gentle"),
  "秋の風は気持ちいいです": (
    "aki no kaze wa kimochi ii desu",
    "The autumn breeze feels nice"
  ),
  "この部屋は明るいです": ("kono heya wa akarui desu", "This room is bright"),
  "彼女は毎晩音楽を聴きます": (
    "kanojo wa maiban ongaku o kikimasu",
    "She listens to music every night"
  ),
  "彼の犬は賢いです": ("kare no inu wa kashikoi desu", "His dog is smart"),
  "この道は曲がりくねっています": (
    "kono michi wa magarikunetteimasu",
    "This road is winding"
  ),
  "彼の手は暖かいです": ("kare no te wa atatakai desu", "His hands are warm"),
  "授業の前に宿題を終わらせてください": ("Jugyou no mae ni shukudai o owarasete kudasai", "Please finish your homework before the class"),
  "彼は私の前で立ち止まった": ("Kare wa watashi no mae de tachidomatta", "He stopped in front of me"),
  "駅の前に大きな公園があります": ("Eki no mae ni oukina kouen ga arimasu", "There is a large park in front of the station"),
  "会議の前に資料を準備しておいてください": ("Kaigi no mae ni shiryou o junbi shite oite kudasai", "Please prepare the materials before the meeting"),
  "車が前に進んでいない": ("Kuruma ga mae ni susunde inai", "The car isn't moving forward"),
};

const WORDS_3000_MAP = {
  "行く": ("iku", "go"),
  "見る": ("miru", "see, look at"),
  ...
  "子供": ("kodomo", "child"),
  "そう": ("sou", "so, that way"),
  "もう": ("mou", "another, again, already, yet"),
  "学生": ("gakusei", "student"),
  "熱い": ("atsui", "hot (to touch)"),
  "どうぞ": ("douzo", "please"),
  "午後": ("gogo", "afternoon, p.m."),
  ...
  "重い": ("omoi", "heavy"),
  "胸": ("mune", "chest, breast"),
  "払う": ("harau", "pay money, pay respect, pay attention"),
  ...
  "悲しい": ("kanashii", "sad"),
  "しゃべる": ("shaberu", "chat, talk"),
  "近く": ("chikaku", "in the near future, before long, near, close to"),
  "甘い": ("amai", "sweet"),
  "テーブル": ("te-buru", "table"),
  "食べ物": ("tabemono", "food (colloquial)"),
  "始まる": ("hajimaru", "begin"),
  ...
  "二": ("ni", "two"),
  "締める": ("shimeru", "tighten, fasten"),
  "まずい": ("mazui", "bad taste, distasteful, problematic, troublesome"),
  ...
  "木曜日": ("mokuyoubi", "Thursday"),
  "曜日": ("youbi", "day of the week"),
  "そば": ("soba", "side, vicinity, buckwheat noodles"),
  ...
  "雨": ("ame", "rain"),
  "金": ("kane/kin", "money (colloquial)/gold"),
  "易しい": ("yasashii", "easy, simple (colloquial)"),
  "お兄さん": ("oniisan", "older brother"),
  "大きい": ("ooki", "big"),
  "小さい": ("chiisai", "small"),
  "辛い": ("karai/tsurai", "spicy, hot, hard, painstaking"),
  "八": ("hachi", "eight"),
  ...
  "何"
      "nan"
      "what. それはなんですか. What is that?"
      "今朝": ("kesa", "this morning"),
  "寿司": ("sushi", "sushi"),
  "履く": ("haku", "put on (shoes),, wear (pants, skirt)"),
  "おじさん": ("ojisan", "uncle, mister, middle-aged man"),
  ...
  "うまい": ("umai", "good at, sweet, delicious"),
  "明るい": ("akarui", "bright, cheerful"),
  "急ぐ": ("isogu", "hurry, do quickly"),
  "歌": ("uta", "song"),
  "中学校": ("chuugakkou", "junior high school"),
  ...
  "まあまあ": ("maamaa", "OK, not bad, now now, well well"),
  "黄色": ("kiiro", "yellow color"),
  "ランチ": ("ranchi", "lunch"),
  "魚": ("sakana", "fish"),
  "味": ("aji", "taste, flavor"),
  ...
  "どんどん": ("dondon", "knock, bang, quickly, rapidly"),
  "並べる": ("naraberu", "line up, arrange"),
  "逃げる": ("nigeru", "escape, run away"),
  ...
  "なかなか": ("nakanaka", "rather, pretty, not easily, not readily"),
  ...
  "おかしい": ("okashii", "strange, peculiar, funny, comical"),
  ...
  "コート": ("ko-to", "coat, jacket, sports court"),
  "趣味": ("shumi", "hobby, interest"),
  ...
  "結構": ("kekkou", "quite, all right, no thank you"),
  "悪口": ("warukuchi", "slander, abuse"),
  "広まる": ("hiromaru", "spread, get around"),
  "内緒": ("naisho", "secrecy, privacy"),
  "つぶる": ("tsuburu", "close (eyes)"),
  ...
  "割れる": ("wareru", "crack, split"),
  "駅員": ("ekiin", "station attendant"),
  "おしゃべり": ("oshaberi", "talkative, chatty, chatter, idle talk"),
  "緑色": ("midoriiro", "green color"),
  "毎朝": ("maiasa", "every morning"),
  "曲げる": ("mageru", "bend (something)"),
  ...
  "電話帳": ("denwachou", "telephone book"),
  "ベル": ("beru", "bell"),
  "干す（ほす）": ("hosu", "hang (something), out to dry"),
  "金額": ("kingaku", "amount of money, sum"),
  "蚊": ("ka", "mosquito"),
  ...
  "凍る": ("kooru", "freeze"),
  "ごみ": ("gomi", "trash"),
  "スーパーマーケット": ("su-pa-ma-ketto", "supermarket"),
  ...
  "ウール": ("wu-ru", "wool"),
  "コーラ": ("ko-ra", "cola, coke"),
  "トイレットペーパー": ("Toirettopepa", "toilet paper"),
  ...
  "カレーライス": ("kareaisu", "curry rice"),
  "キャッシュカード": ("Kyasshukado", "cash card"),
  "停留所": ("teiryuujo", "bus stop"),
  "床屋": ("tokoya", "barber, barbershop"),
  "歯磨き": ("hamigaki", "brushing one's teeth"),
  "夕飯"
  ...
  "臭い": ("kusai/nioi", "stinky/bad smell"),
  "突き当たり": ("tsukiatari", "end of a street"),
  "マフラー": ("mafura-", "scarf, muffler"),
  "桃": ("momo", "peach"),
  "アクセサリー": ("akusesari-", "accessories, jewelry"),
  "あくび": ("akubi", "yawn"),
  "あめ": ("ame", "candy"),
  "上り": ("nobori", "going up, ascent"),
  "なるべく": ("narubeku", "as…as possible, if possible"),
  ...
  "掃く": ("haku", "sweep"),
  "何しろ": ("nanishiro", "anyhow, as you may know"),
  "ぺこぺこ": ("pekopeko", "hungry, starving, bow, kowtow"),
  "ぺらぺら": ("perapera", "fluently"),
  "レインコート": ("reinkoto", "raincoat"),
  ...
  "温泉": ("onsen", "hot spring"),
  "トレーニング": ("tore-ningu", "training, workout"),
  "噂": ("uwasa", "gossip, rumor"),
  "本物": ("honmono", "real, truly worthy (things, people)"),
  "アイデア": ("aidea", "idea"),
  "地下": ("chika", "underground"),
  ...
  "もったいない": ("mottainai", "wasteful, a shame"),
  ...
  "シャープペンシル": ("shaapupenshiru", "mechanical pencil"),
  ...
  "屋上": ("okujou", "housetop, rooftop"),
  "蓋": ("futa", "lid, cover"),
  "いつの間にか": ("itsunomanika", "before noticing it, out of nowhere"),
  "象": ("zou", "elephant"),
  "嫌がる": ("iyagaru", "dislike, be unwilling"),
  ...
  "ゆでる": ("yuderu", "boil"),
  "できるだけ": ("dekirudake", "as (much), as possible"),
  "もしかしたら": ("moshikashitara", "possibly, perhaps"),
  ...
  "立ち入り禁止": ("tachiirikinshi", "no trespassing"),
  ...
  "問い合わせる": ("toiawaseru", "inquire, ask for (information)"),
  "しょっちゅう": ("shocchuu", "frequently, repeatedly"),
  "ロープ": ("roopu", "rope"),
  "ストライキ": ("sutoraiki", "strike"),
  "パンク": ("panku", "flat tire"),
  "コマーシャル": ("komaasharu", "commercial, advertising"),
  ...
  "ゴールデンウィーク": ("goorudenwiiku", "golden week"),
  "シューズ": ("shuuzu", "shoes"),
  "未成年": ("miseinen", "minor, underage"),
  "甥": ("oi", "nephew"),
  "葉っぱ": ("happa", "leaf"),
  ...
  "社会人": ("shakaijin", "working member of society"),
  "大急ぎ": ("ooisogi", "in a great hurry"),
  "セルフサービス": ("serufusaabisu", "self-service"),
  "くしゃくしゃ": ("kushakusha", "messy, crumpled"),
  ...
  "つるつる": ("tsurutsuru", "smooth, slippery"),
  "こしょう": ("koshou", "pepper"),
  "びしょびしょ": ("bishobisho", "soaking wet, soaked"),
  "ぎゅうぎゅう": ("gyuugyuu", "packed, crammed"),
  ...
  "じゃんじゃん": ("janjan", "many times, repeatedly"),
  "見違える": ("michigaeru", "look completely different"),
